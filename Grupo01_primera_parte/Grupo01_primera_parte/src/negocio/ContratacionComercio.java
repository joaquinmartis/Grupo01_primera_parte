...
public class ContratacionComercio extends Contratacion {
    ...
    public ContratacionComercio(int camaras, int botonesAntipanico, boolean movilAcompanamiento, Domicilio domicilio, int id){
        super(camaras, botonesAntipanico, movilAcompanamiento, domicilio, id);
